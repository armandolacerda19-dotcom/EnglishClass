...
Última atualização: 2026-08-26, mais 5 updates: AI Tutor passa a registar erros recorrentes no SRS de verdade (`ERROR_LOGGED:` parseado da resposta), Micro-Desafios alimentam o octógono, 2 micro-desafios novos, 1 texto de leitura novo, 8ª lição ("Making Plans" — `going to` future). Deploy `b583b7a` (AI Tutor conta para XP) confirmado publicado sem erros. Ver `docs/decisions.md`.
