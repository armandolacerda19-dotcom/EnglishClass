...
| 19 | Role-play | ⚠️ **honestidade adicionada (auditoria 2026-08-28)**: usa a personalidade "roleplay" do tutor e a mesma avaliação de fim de conversa do tipo 9, mas **não tem cenários/conteúdo distintos** (restaurante/hotel/entrevista) nem UI própria — é a mesma Conversação com IA com uma personalidade diferente, não uma implementação separada. Continua a contar como "existe", não como "type 19 genuinamente distinto de type 9" |
