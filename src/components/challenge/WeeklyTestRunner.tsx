...
export function WeeklyTestRunner({ questions }: WeeklyTestRunnerProps) {
  ...
  // ver checkAnswer.ts/gradeAnswer.ts. Escolha múltipla usa igualdade exata
  // (checkChoiceAnswer); texto livre usa correção tolerante por IA
  // (checkFreeTextAnswer), porque comparar por igualdade exata penalizava
  // traduções válidas mas com fraseado diferente da referência.
  //
  ...
  // embutido no payload de TODAS as perguntas do teste — dava para ler as
