...
// Cada pilar tem 3 perguntas (Pre-A1/A1 → A2 → B1) para estimar um teto aproximado sem
// exigir um motor de item-response completo (esse fica para MVP2, ver docs/10-scope-mvp1.md).
...
export interface PlacementQuestion {
  ...
  difficultyLevel: "PRE_A1" | "A1" | "A2" | "B1";
  prompt: string;
  options?: string[];
